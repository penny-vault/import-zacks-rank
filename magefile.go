...
const (
	binaryName   = "import-zacks-rank"
	packageName  = "."
	noGitLdflags = "-X github.com/penny-vault/import-zacks-rank/common.buildDate=$BUILD_DATE"
)

var ldflags = "-X github.com/penny-vault/import-zacks-rank/common.commitHash=$COMMIT_HASH -X github.com/penny-vault/import-zacks-rank/common.buildDate=$BUILD_DATE"
...
var (
	pkgPrefixLen = len("github.com/penny-vault/import-zacks-rank")
	pkgs         []string
	pkgsInit     sync.Once
)
